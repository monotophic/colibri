/* fmt=100 (native FP8-e4m3 passthrough) CPU kernel tests: LUT exactness (all 256
 ...
 * Ported onto dev post-#465-merge as fmt=100 from the start (PRIVATE ORDINAL
 * BLOCK, see colibri.c's QT struct comment) -- there was never a build in this
 * branch's new history where this format was reachable as fmt=6. */
#include "../quant.h"
#include <stdio.h>
#include <string.h>
#include <math.h>
 ...
 * cpu_ref_grouped/run_grouped established for fmt=4 and reuses for fmt=100 on the
